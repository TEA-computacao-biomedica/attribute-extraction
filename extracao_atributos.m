...
% superposicao - Superposi��o da janela
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% "JANELAMENTO" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
    ...
    jan_tot =round(janela/(1/Fs));                % n�mero de pontos de uma janela
    superpos = round(superposicao/(1/Fs));        % n�mero de pontos da superposi��o
    step = jan_tot-superpos;                      % step
    num_janelas = floor(((size(Y,1)-jan_tot)/step)+1);  % n�mero total de janelas
